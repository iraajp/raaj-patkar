...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: 'google' | 'logout' | 'add' | 'delete' | 'edit' | 'play' | 'new' | 'regenerate' | 'close' | 'download';
}
    ...
    case 'google':
      return (
        <svg {...props} aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
            <path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 23.4 172.9 61.9l-76.2 64.5C307.4 99.4 280.7 86 248 86c-84.3 0-152.3 67.8-152.3 151.4s68 151.4 152.3 151.4c97.9 0 130.4-74.4 134.7-109.4H248v-85.3h236.1c2.3 12.7 3.9 26.9 3.9 41.4z"></path>
        </svg>
      );
    case 'logout':
        return (
